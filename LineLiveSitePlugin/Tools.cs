...
namespace LineLiveSitePlugin.ParseMessage
{
    ...
    {
        List<(IMessage, IUser)> Messages { get; }
    }
...
namespace LineLiveSitePlugin
{
                ...
                case "bulk":
                    {
                        ...
                        var data = k.Data;
                        var list = new List<(ParseMessage.IMessage, ParseMessage.IUser)>();
    ...
    {
        public List<(ParseMessage.IMessage, ParseMessage.IUser)> Messages { get; set; }
    }
}
