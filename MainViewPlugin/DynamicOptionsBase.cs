...
namespace Common
{
    ...
    public abstract class DynamicOptionsBase : INotifyPropertyChanged
    {
        ...
        protected class Item
        {
            ...
            /// </summary>
            public Predicate<dynamic> Predicate { get; set; } = default;
            public dynamic DefaultValue { get; set; } = default;
            public dynamic Value { get; set; } = default;
            public Func<dynamic, string> Serializer { get; set; } = default;
            public Func<string, dynamic> Deserializer { get; set; } = default;
