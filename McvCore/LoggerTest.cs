...
namespace McvCore
{
    ...
    {
        readonly System.Collections.Concurrent.BlockingCollection<ExceptionContext> _exCollection = new();
        public void LogException(Exception ex, string title = "", string detail = "")
        {
            var error = new Error(ex);
            _exCollection.Add(new ExceptionContext(error, title, detail));
        }
        ...
        [Serializable]
        public record ExceptionContext(Error Ex, string Title, string Detail);
