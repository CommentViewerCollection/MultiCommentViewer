...
namespace MirrativSitePlugin
{
    ...
    internal abstract class MessageMetadataBase : IMirrativMessageMetadata
    {
    ...
    internal class ConnectedMessageMetadata : MessageMetadataBase
    {
        ...
        protected internal ConnectedMessageMetadata(IMirrativConnected connected, ICommentOptions options, IMirrativSiteOptions siteOptions)
