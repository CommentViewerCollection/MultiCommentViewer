...
{
    internal interface IMixerMessageMetadata: IMessageMetadata
    {

    }
    internal abstract class MessageMetadataBase : IMixerMessageMetadata
    {
        //protected readonly IMixerMessage _message;
        protected readonly ICommentOptions _options;
        protected readonly IMixerSiteOptions _siteOptions;
    ...
    internal class ConnectedMessageMetadata : MessageMetadataBase
    {
        ...
        protected internal ConnectedMessageMetadata(IMixerConnected connected, ICommentOptions options, IMixerSiteOptions siteOptions)
    ...
    //internal class MixerMessageMetadata : IMessageMetadata
    //{
    //    private readonly IMixerMessage _message;
    ...
    //                return _options.FirstCommentBackColor;
    //            }
    //            else if (_message is IMixerConnected)
    //            {
    //                return _options.BroadcastInfoBackColor;
    //            }
    //            else if(_message is IMixerDisconnected)
    //            {
    //                return _options.BroadcastInfoBackColor;
    //            }
    //            else if(_message is IMixerJoinRoom)
    //            {
    //                return _options.BroadcastInfoBackColor;
    //            }
    //            else if (_message is IMixerItem item)
    //            {
    ...
    //    public bool IsNameWrapping => _options.IsUserNameWrapping;
    //    public Guid SiteContextGuid { get; set; }
    //    public MixerMessageMetadata(IMixerMessage message, ICommentOptions options, IMixerSiteOptions siteOptions, IUser user, ICommentProvider cp, bool isFirstComment)
    //    {
    //        if(user == null)
    //        {
