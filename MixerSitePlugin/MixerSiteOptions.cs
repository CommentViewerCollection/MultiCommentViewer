...
{
    internal class MixerSiteOptions : DynamicOptionsBase, IMixerSiteOptions
    {
        /// <summary>
        /// @コテハンを自動登録するか
        /// </summary>
        ...
        internal MixerSiteOptions Clone()
        {
            return (MixerSiteOptions)this.MemberwiseClone();
        }
        internal void Set(MixerSiteOptions changedOptions)
        {
