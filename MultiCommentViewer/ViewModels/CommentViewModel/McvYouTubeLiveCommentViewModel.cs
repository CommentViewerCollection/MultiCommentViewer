...
namespace MultiCommentViewer
{
    public class McvBigoCommentViewModel : McvBigoCommentViewModelBase
    {
        ...
        //    public McvBigoCommentViewModel(YouTubeLiveSitePlugin.IYouTubeLiveComment comment, IMessageMetadata metadata, IMessageMethods methods, IConnectionStatus connectionStatus, IOptions options)
