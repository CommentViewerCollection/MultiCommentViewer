...
namespace MultiCommentViewerTests
{
    ...
    class CommentViewModelSiteColorTests
    {
        ...
        private void Test1(Func<IMessageMetadata, IMessageMethods, ConnectionName, IOptions, IMcvCommentViewModel> f)
        {
            ...
            var cvm = f(metadata, methods, connectionName,options);// new MultiCommentViewer.McvMirrativCommentViewModel(message, metadata, methods, connectionName, options);
