...
//        }
//    }
//    class ShowRoomCommentProvider : ICommentProvider
//    {
...
//                        if (!_userCommentDict.TryGetValue(user, out ObservableCollection<ShowRoomCommentViewModel> userComments))
//                        {
//                            userComments = new ObservableCollection<ShowRoomCommentViewModel>();
//                            _userCommentDict.Add(user, userComments);
//                        }
//                        var isFirstComment = userComments.Count == 0;
//                        var cvm = new ShowRoomCommentViewModel(_options, _siteOptions, commentData, _emotIcons, isFirstComment, this, user);
...
//                    break;
//                default:
//                    Debug.WriteLine($"ShowRoom unknown command={result.Command}");
...
//        }
//        private readonly Dictionary<IUser, ObservableCollection<ShowRoomCommentViewModel>> _userCommentDict = new Dictionary<IUser, ObservableCollection<ShowRoomCommentViewModel>>();
//        private readonly IDataServer _server;
//        private readonly ILogger _logger;
//        private readonly ICommentOptions _options;
//        private readonly ShowRoomSiteOptions _siteOptions;
//        private readonly IUserStore _userStore;
//        private readonly Dispatcher _dispatcher;
//        public ShowRoomCommentProvider(IDataServer server, ILogger logger, ICommentOptions options, ShowRoomSiteOptions siteOptions, IUserStore userStore, Dispatcher dispacher)
//        {
//            _server = server;
//            _logger = logger;
//            _options = options;
...
//        }
//    }
//    public class ShowRoomSiteContext : ISiteContext
//    {
//        public Guid Guid => new Guid("22F7824A-EA1B-411E-85CA-6C9E6BE94E39");

//        public string DisplayName => "ShowRoom";
...
//        {
//            return new ShowRoomCommentProvider(new ShowRoomServer(), _logger, _options, _siteOptions, _userStore, _dispatcher);
//        }
...
//        private readonly IUserStore _userStore;
//        private readonly Dispatcher _dispatcher;
//        public ShowRoomSiteContext(ICommentOptions options, ILogger logger, IUserStore userStore, Dispatcher dispatcher)
//        {
//            _options = options;
//            _logger = logger;
//            _userStore = userStore;
