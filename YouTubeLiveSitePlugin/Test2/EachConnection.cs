...
namespace YouTubeLiveSitePlugin.Test2
{
    ...
    //        var liveChat = LiveChat.Parse(await GetLiveChatHtml(vid));
    //        if(liveChat.YtInitialData.Continuation == null)
    //        {
    //            //放送終了
    ...
    //        //}
    //        //コメント投稿に必要なものの準備
    //        PrepareForPostingComments(liveChat.YtCfg.IsLoggedIn, liveChat.YtCfg.XsrfToken,liveChat.YtInitialData.MessageSendButtonServiceEndpoint,liveChat.YtInitialData.MessageSendButtonServiceEndpointClientIdPrefix);
    ...
    //        var metaTask = CreateMetadataReceivingTask(ref metaProvider, browserType, vid, liveChat.YtCfg);
    //        if (metaTask != null)
    //        {
    //            tasks.Add(metaTask);
    //        }
    ...
    //        };
    //        var continuation = _siteOptions.IsAllChat ? liveChat.YtInitialData.AllChatContinuation : liveChat.YtInitialData.JouiChatContinuation;
    ...
    //    }
    //    protected virtual Task CreateMetadataReceivingTask(ref IMetadataProvider metaProvider, BrowserType browserType, string vid,YtCfg ytCfg2)
    //    {
    ...
    //            SendInfo(e.Comment, e.Type);
    //        };
    //        var metaTask = metaProvider.ReceiveAsync(ytCfg: ytCfg2, vid: vid, cc: _cc);
    //        return metaTask;
    //    }
    //    private void PrepareForPostingComments(bool isLoggedIn, string xsrfToken,string? serviceEndpoint, string? clientIdPrefix)
    //    {
    //        //var liveChatContext = Tools.GetLiveChatContext(liveChatHtml);
    //        IsLoggedIn = isLoggedIn;// liveChatContext.IsLoggedIn;
    //        if(serviceEndpoint != null)
    //        {
    //            PostCommentContext = new PostCommentContext
    //            {
    //                ClientIdPrefix = clientIdPrefix,
    //                SessionToken = xsrfToken,// liveChatContext.XsrfToken,
    //                Sej = serviceEndpoint,
    //            };
    //        }
