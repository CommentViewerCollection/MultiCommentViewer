//! ABI v4 – struct pointer based ABI
//!
//! 推奨方式（将来拡張可能）
...
pub struct PluginV4 {
    ...
    /// HostRuntime へのポインタ
    pub host: *const HostRuntimeV4,

    /// ライフサイクル
    pub on_loaded: unsafe extern "C" fn(*mut PluginV4) -> i32,
    pub on_message: unsafe extern "C" fn(
        *mut PluginV4,
        msg_ptr: *const u8,
        msg_len: usize,
    ) -> i32,
    pub on_shutdown: unsafe extern "C" fn(*mut PluginV4) -> i32,
